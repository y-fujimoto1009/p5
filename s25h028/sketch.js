...
let x1 = 160;
let y1 = 225;
let x2 = lerp(160, 240, constrain((step - 180) / 30, 0, 1));
let y2 = lerp(230, 175, constrain((step - 120) / 30, 0, 1));
line(x1, y1, x2, y2);
}
// テキストアニメーション（フェードイン）
 if (step > 120) {
let t = constrain((step - 200) / 80, 0, 1);
let moveY = lerp(40, 20, t);
let alpha = t * 255;
fill(20, 50, 200, alpha);
noStroke();
textSize(52);
textAlign(CENTER);
